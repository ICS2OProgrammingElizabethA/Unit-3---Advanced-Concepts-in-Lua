...
local function PositionAnswers()
    ...
    elseif (randomPosition == 2) then
        ...
        --alternateAnswerBox3
        alternateAnswerBox3.y = display.contentHeight * 0.10
    ...
    -- random position 3
     elseif (randomPosition == 3) then
        ...
        --alternateAnswerBox2
        alternateAnswerBox2.y = display.contentHeight * 0.45
    ...
    -- random position 4
     elseif (randomPosition == 4) then
        ...
        --alternateAnswerBox3
        alternateAnswerBox3.y = display.contentHeight * 0.64
...
local function YouLoseTransitionLevel1( )
    composer.gotoScene("you_lose", {effect = "slideDown", time = 500})
end
